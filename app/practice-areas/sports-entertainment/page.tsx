...
export const metadata: Metadata = {
  title: "الرياضة والترفيه | إدارة الحقوق والعقود والرعايات",
  description:
    "خدمات قانونية متخصصة للقطاع الرياضي والترفيهي: عقود اللاعبين والفِرق، إدارة الرعايات، وحقوق البث والفعاليات.",
  keywords: "رياضة, ترفيه, رعاية, بث, عقود, الجزائر",
  openGraph: {
    title: "الرياضة والترفيه في الجزائر | احترافية وثقة",
    description: "نصيغ ونفاوض العقود ونحمي الحقوق التجارية للجهات الرياضية والترفيهية.",
  },
}
...
const SE_STATS: Stat[] = [
  { value: "80+", label: "فعالية سنوية", description: "بطولات ومهرجانات" },
  { value: "$60M+", label: "حجم رعايات", description: "عقود وتسويق" },
  { value: "900+", label: "عقد احترافي", description: "لاعبين ومدربين" },
  { value: "120+", label: "اتفاق بث", description: "قنوات ومنصات رقمية" },
]
    ...
    <main dir="rtl" className="min-h-screen overflow-x-hidden text-gray-800">
      <div className="fixed inset-0 -z-10">
        ...
        <svg className="absolute inset-0 h-full w-full opacity-10 text-white" aria-hidden>
          <defs>
            <pattern id="dots-se" width="28" height="28" patternUnits="userSpaceOnUse">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center text-white">
            <ScrollReveal direction="up" delay={150}>
              <h1 className="mb-4 text-3xl font-extrabold leading-tight md:text-5xl">الرياضة والترفيه</h1>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={220}>
              <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed md:text-xl text-white/90">
                ندير الحقوق والعقود والرعايات بمرونة واحترافية—من حماية العلامات إلى اتفاقيات
                البث وتنظيم الفعاليات.
              </p>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={300}>
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button asChild size="lg" className="bg-white text-corporate-green hover:bg-white/90">
                  <Link href="/forms">اطلب استشارة</Link>
                </Button>
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal direction="up" delay={150}>
            <div className="text-center mb-10">
              ...
              <p className="text-white/90 max-w-2xl mx-auto">حجم القطاع الرياضي والترفيهي.</p>
            </div>
          </ScrollReveal>
      ...
      <CTASection
        title="حوكمة وعقود تضمن الاستمرارية"
        description="نصيغ ونراجع ونتفاوض على العقود والرعايات بما يحمي مصالحك ويعظّم العائد."
