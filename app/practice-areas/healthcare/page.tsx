...
const HC_STATS: Stat[] = [
  { 
    ...
    description: "مقارنة بالقضاء التقليدي",
    ariaLabel: "70 بالمائة توفير في التكاليف مقارنة بالقضاء التقليدي"
  },
  { 
    value: "90%", 
    label: "نسبة نجاح الوساطة", 
    description: "عالمياً في النزاعات الصحية",
    ariaLabel: "90 بالمائة نسبة النجاح العالمية للوساطة في النزاعات الصحية"
  },
  { 
    value: "30", 
    label: "يوم متوسط", 
    description: "للوصول إلى حل",
    ariaLabel: "30 يوماً متوسط المدة للوصول إلى حل"
  },
  { 
    value: "24/7", 
    label: "دعم متواصل", 
    description: "فريق متخصص",
    ariaLabel: "دعم متواصل على مدار الساعة من فريق متخصص"
  },
]
