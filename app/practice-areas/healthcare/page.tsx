...
export const metadata: Metadata = {
  title: "الرعاية الصحية | جودة وعناية وامتثال",
  description:
    "حلول قانونية للمؤسسات الصحية: التراخيص، التعاقد، حماية البيانات الصحية، وإدارة المخاطر والامتثال.",
  keywords: "صحة, مستشفيات, امتثال, بيانات صحية, الجزائر",
  openGraph: {
    title: "قطاع الرعاية الصحية في الجزائر | امتثال وثقة",
    description: "نساعدك على تقديم الرعاية بثقة مع امتثال تنظيمي صارم وإدارة مخاطر فعالة.",
  },
}
...
const HC_STATS: Stat[] = [
  { value: "750+", label: "مرفق صحي", description: "عام وخاص" },
  { value: "120k+", label: "ممارس صحي", description: "أطباء وتمريض وتقنيون" },
  { value: "98.5%", label: "امتثال البيانات", description: "سياسات حماية المعلومات" },
  { value: "2.3k+", label: "عقد سنوي", description: "توريد وخدمات وتشغيل" },
]
    ...
    <main dir="rtl" className="min-h-screen overflow-x-hidden text-gray-800">
      <div className="fixed inset-0 -z-10">
        ...
        <svg className="absolute inset-0 h-full w-full opacity-10 text-white" aria-hidden>
          <defs>
            <pattern id="dots-hc" width="28" height="28" patternUnits="userSpaceOnUse">
              <circle cx="1" cy="1" r="1" fill="currentColor" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#dots-hc)" />
        </svg>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center text-white">
            <ScrollReveal direction="up" delay={150}>
              <h1 className="mb-4 text-3xl font-extrabold leading-tight md:text-5xl">الرعاية الصحية</h1>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={220}>
              <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed md:text-xl text-white/90">
                نمكّن المستشفيات والمراكز الصحية من تقديم رعاية عالية الجودة عبر حلول قانونية
                تضمن الامتثال، حماية البيانات، وإدارة المخاطر.
              </p>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={300}>
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button asChild size="lg" className="bg-white text-corporate-green hover:bg-white/90">
                  <Link href="/forms">ابدأ تعاوناً</Link>
                </Button>
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal direction="up" delay={150}>
            <div className="text-center mb-10">
              ...
              <p className="text-white/90 max-w-2xl mx-auto">ملامح أساسية لقطاع الرعاية الصحية.</p>
            </div>
          </ScrollReveal>
      ...
      <CTASection
        title="رعاية أفضل بامتثال أقوى"
        description="نقدّم أطر حوكمة وعقود وخطط امتثال لحماية المرضى والمنشآت."
