...
export default function RegulationsDashboardCommercialPage() {
  ...
  return (
    <div dir="rtl" className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-[#003366]">إدارة التشريعات التجارية الوطنية</h1>
        <p className="text-sm text-muted-foreground">رفع وإدارة الوثائق الخاصة بصفحة التشريعات التجارية الوطنية.</p>
      </div>
      ...
      <Card className="rounded-2xl shadow-md mb-6">
        ...
        <CardContent>
          ...
          <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label>الفئة</Label>
              <Input value={category} onChange={(e) => setCategory(e.target.value)} placeholder="لوائح تجارية / قوانين الشركات .." />
            </div>
