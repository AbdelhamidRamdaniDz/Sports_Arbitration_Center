...
export default function OverviewPage() {
  const goals = [
    ...
    { 
      title: "نشر ثقافة الوسائل البديلة لتسوية النزاعات", 
      icon: Users, 
      desc: "كخيار فعّال وسريع وموثوق لحل الخلافات بعيدًا عن التعقيدات القضائية.",
      color: "from-purple-500 to-purple-600"
    },
    { 
      title: "تعزيز التحول الرقمي", 
      icon: Zap, 
      desc: "تحسين الإجراءات الرقمية في تسوية النزاعات لتقديم تجربة فعّالة وشفافة لجميع الأطراف.",
    ...
    { 
      ...
      icon: Briefcase, 
      desc: "تأهيل الكفاءات في تسوية النزاعات، خاصة في المجالين التجاري والرياضي. لتلبية احتياجات السوق وتعزيز ثقافة العدالة البديلة.",
