...
export default function DigitalTransformationPage() {
  ...
  const visionPoints = [
    ...
    },
    {
      icon: Globe,
      title: "ريادة إقليمية",
      description: "جعل الجزائر مركزًا رائدًا في التحكيم الإلكتروني على مستوى شمال إفريقيا والعالم العربي"
    },
    {
      icon: Rocket,
      title: "ابتكار مستمر",
                ...
                <Card className="shadow-2xl border-2 border-green-100 hover:border-corporate-green/50 rounded-3xl overflow-hidden transition-all">
                  ...
                  <CardContent className="p-8 bg-white">
                    <div className="text-gray-600 leading-7 space-y-4">
                      <p>
                        تمثل منصتنا خطوة رائدة في دعم التحول الرقمي للقطاع القضائي في الجزائر، بما يتماشى مع رؤية الجزائر 2030 الهادفة إلى رقمنة الخدمات العامة وتعزيز الابتكار التكنولوجي كما نطمح إلى تعزيز الكفاءة محليًا وإقليميًا، لتصبح الجزائر نموذجًا رائدًا في العدالة البديلة الرقمية.
                      </p>
                      <p>
