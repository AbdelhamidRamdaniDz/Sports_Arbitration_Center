  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader
        ...
        title="شركاؤنا"
        description="نتطلع لإبرام شراكات استراتيجية مع شركات، واتحادات رياضية جزائرية لدعم وتطوير منظومة التحكيم الرياضي والتجاري محليًا وإقليميا "
      />
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
             نُطوّر نموذجًا مبتكرًا للتعاون مع الشركاء المحليين والدوليين، لدعم خدماتنا في تسوية النزاعات البديلة، بما في ذلك التحكيم والوساطة في المجالين التجاري والرياضي. ونؤمن بأن الشراكة والتعاون يشكّلان أساسًا لتعزيز الجودة والشفافية في منظومة العدالة البديلة.
            </p>
          </div>
